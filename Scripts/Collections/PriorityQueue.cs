 ...
 * 
 * modified for use in this game by Meep - 2020
 */
...
namespace System.Collections.Generic {
  ...
  public class PriorityQueue<TPriority, TValue> 
    ...
    /// </summary>
    public bool isEmpty {
      get => _baseHeap.Count == 0;
    }

    /// <summary>
    /// The base heap used to store the priorities and values
    /// </summary>
    readonly List<KeyValuePair<TPriority, TValue>> _baseHeap;
    ...
    /// </summary>
    /// <returns>if an element was found to dequeue</returns>
    public bool tryDequeue(out KeyValuePair<TPriority, TValue> item) {
      if (!isEmpty) {
        item = _baseHeap[0];
        DeleteRoot();
        return true;
    ...
    /// </remarks>
    public bool tryPeek(out KeyValuePair<TPriority, TValue> item) {
      if (!isEmpty) {
        item = _baseHeap[0];
        return true;
      } else {
